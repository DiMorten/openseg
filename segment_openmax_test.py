...
#     weibull_model = weibull_tailfitting(mean_list, dist_list, num_known_classes, tailsize=10000)
    ...
    # Computing test.
    test(test_loader, net, criterion, epoch, num_known_classes, num_unknown_classes, hidden, args, True, epoch % args['save_freq'] == 0, weibull_model)
...
def test(test_loader, net, criterion, epoch, num_known_classes, num_unknown_classes, hidden, args, save_images, save_model, weibull_model):
